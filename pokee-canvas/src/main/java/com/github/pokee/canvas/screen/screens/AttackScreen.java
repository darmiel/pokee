package com.github.pokee.canvas.screen.screens;

import com.github.pokee.canvas.util.DrawablePokemon;
...
import com.github.pokee.canvas.util.ColorUtils;
import com.github.pokee.canvas.util.SpriteType;
import com.github.pokee.canvas.font.Fonts;
import com.github.pokee.canvas.screen.Screen;
import com.github.pokee.canvas.screen.result.PopRenderResult;
...
public class AttackScreen extends Screen {
    ...
    public AttackScreen(final Canvas canvas, final int attackerID, final int defenderID) throws IOException {
        ...
        final DrawablePokemon attacker = new DrawablePokemon(attackerID);
        this.attackerSprite = attacker.getSprite(SpriteType.BACK);
